...
function legacyCopy(text: string, selectionTarget?: HTMLInputElement): boolean {
...
export function copyText(text: string, selectionTarget?: HTMLInputElement): Promise<boolean> {
  const clipboard =
